...
static const char* const kClassDocumentDetector = "com/websitebeaver/documentscanner/DocumentDetector";
...
//        {
//                "nativeScan",
//                "(Landroid/graphics/Bitmap;[Landroid/graphics/Point;II)V",
//                (void*)native_scan
//        },
//
//        {
...
//    jclass classDocumentDetector = env->FindClass(kClassDocumentDetector);
//    if(env -> RegisterNatives(classDocumentDetector, gMethods, sizeof(gMethods)/ sizeof(gMethods[0])) < 0) {
//        return JNI_FALSE;
//    }
    initClassInfo(env);
...
Java_com_websitebeaver_documentscanner_DocumentDetector_00024Companion_nativeCrop(JNIEnv *env,
                                                                                  jobject thiz,
                                                                                  jobject src_bitmap,
                                                                                  jobjectArray points,
                                                                                  jobject out_bitmap) {
...
Java_com_websitebeaver_documentscanner_DocumentDetector_00024Companion_nativeScan(JNIEnv *env,
                                                                                  jobject thiz,
                                                                                  jobject src_bitmap,
